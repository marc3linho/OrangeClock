    ...
    <html>
    	<body style="background-color: #D3D3D3;">
            <h1 style="color: #5e9ca0; text-align: center;">
                <span style="color: #e86223;">
                    Orange Clock Wi-Fi Setup
                </span>
            </h1>
    ...
    client.sendall(
        """\
            ...
            <ul>
                ...
                <li>
                    Changes for the Orange Clock project <a href="https://github.com/marc3linho/orangeclock"
                    target="_blank" rel="noopener">marc3linho/orangeclock</a>.
                </li>
            </ul>
        </body>
    </html>
